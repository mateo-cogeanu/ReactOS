...
function(setup_host_tools)
    ...
    if(NOT SYSWOW64_BUILD)
        ...
        list(TRANSFORM HOST_TOOLS PREPEND "${TOOLS_FOLDER}/bin" OUTPUT_VARIABLE HOST_TOOLS_OUTPUT)
    endif()
    if (CMAKE_HOST_WIN32)
    ...
    # Host tools are already built for WOW64
    if(NOT SYSWOW64_BUILD)
        ...
        # add_custom_target(host-tools COMMAND "" BYPRODUCTS ${HOST_TOOLS_OUTPUT})

        set(INSTALL_DIR ${TOOLS_FOLDER}/../)
    endif()
